...
import wolfsoft.routes.Adapter.CustomPagerAdapter;
...
import static wolfsoft.routes.data.AlarmReminderProvider.LOG_TAG;
    ...
    public class ViewPagerTest extends AppCompatActivity implements
        ...
        private static String TAG = wolfsoft.routes.Profile.class.getSimpleName();
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mGoogleApiClient = new GoogleApiClient.Builder(ViewPagerTest.this)
            ...
            toolbar.setTitle("Teacher At Home");
            ...
            mySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view,
                    ...
                    Toast.makeText(ViewPagerTest.this, spinner_text + lat + lng, Toast.LENGTH_LONG).show();
            ...
            MySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view,
                                           int position, long id) {
                    Spinner_text = MySpinner.getSelectedItem().toString();
                    Toast.makeText(ViewPagerTest.this, Spinner_text + lastname.getText().toString() + telephone.getText().toString(), Toast.LENGTH_LONG).show();
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, image_url,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String s) {
                            ...
                            Toast.makeText(ViewPagerTest.this, s, Toast.LENGTH_LONG).show();
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            ...
                            //Showing toast
                            Toast.makeText(ViewPagerTest.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                        }
                    }) {
                @Override
