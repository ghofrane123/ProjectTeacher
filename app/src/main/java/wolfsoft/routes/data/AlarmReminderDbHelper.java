...
public class AlarmReminderDbHelper extends SQLiteOpenHelper {
    ...
    public void deletereminder() {
        ...
        // Delete All Rows
        db.delete(AlarmReminderContract.AlarmReminderEntry.TABLE_NAME, null, null);
        db.close();

        Log.d("AlarmReminder", "Deleted all reminder info from sqlite");
    }
